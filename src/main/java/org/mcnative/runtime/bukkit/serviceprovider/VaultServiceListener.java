...
package org.mcnative.runtime.bukkit.serviceprovider;
...
import org.mcnative.runtime.bukkit.serviceprovider.economy.VaultEconomyHook;
import org.mcnative.runtime.bukkit.serviceprovider.economy.VaultEconomyProvider;
import org.mcnative.runtime.bukkit.serviceprovider.permission.VaultPermissionHook;
...
public class VaultServiceListener {
    ...
    @Listener
    public void onServiceUnregister(ServiceUnregisterRegistryEvent event) {
        if(event.isServiceType(EconomyProvider.class)) {
